function createOrResetDetalhesVenda2Sheet() {
  ...
  const headersConfig = [
    ...
    { name: "Numero Loja", width: 120, align: "left" },
    { name: "Data", width: 95, align: "center", format: "dd/MM/yyyy" },
    { name: "Total", width: 115, align: "right", format: "R$ #,##0.00" },
    ...
    { name: "Item Valor", width: 110, align: "right", format: "R$ #,##0.00" },
    { name: "Item Custo", width: 110, align: "right", format: "R$ #,##0.00" },
    { name: "Valor Total", width: 120, align: "right", format: "R$ #,##0.00" },
    { name: "Custo Total", width: 120, align: "right", format: "R$ #,##0.00" },
